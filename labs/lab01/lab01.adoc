...
. Copy then unpack the downloaded zip file to *cloud-native-workshop-2019/labs/my_work/cloud-native-spring*
+
Your directory structure should now look like:
+
[source, bash]
---------------------------------------------------------------------
cloud-native-workshop-2019:
├── labs
│   ├── my_work
│   │   ├── cloud-native-spring
---------------------------------------------------------------------
...
*_STS Import Help:_*
+
Select File > Import… Then select Maven > Existing Maven Projects. On the Import Maven Projects page, browse to the /cloud-native-spring directory (e.g. CN-Workshop/labs/my_work/cloud-native-spring)
...
. In a terminal, change working directory to *CN-Workshop-/labs/my_work/cloud-native-spring*
+
$ cd /CN-Workshop/labs/my_work/cloud-native-spring
